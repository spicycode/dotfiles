...
do
	...
	local function apply_overrides()
		...
		hl("NeotestBorder", { fg = colors.blend(palette.bg, palette.water, 60) })
		hl("NeotestIndent", { fg = colors.blend(palette.bg, palette.fg, 35) })
		...
		hl("NeotestWatching", { fg = palette.wood })
